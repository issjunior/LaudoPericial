...
def renderizar_menu():
    ...
    with st.sidebar:
        ...
        # Link do GitHub do Projeto (Posicionado no final do menu)
        st.markdown("""
            <div style="text-align: center; margin-top: 1.5rem; opacity: 0.6;">
                <a href="https://github.com/issjunior?tab=repositories" target="_blank" style="text-decoration: none; color: inherit; font-size: 0.75rem; display: flex; align-items: center; justify-content: center; gap: 8px;">
                    <svg height="16" aria-hidden="true" viewBox="0 0 16 16" version="1.1" width="16" style="fill: currentColor;">
